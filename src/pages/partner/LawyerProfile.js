...
import TnosLawyerLogoMobile from "../../assets/img/technologies/tnos_lawyer_logo_mobile.png";
...
export default () => {
  ...
  const getMonthName = (monthNumber, monthSize = "short") => {
    const date = new Date();
    date.setMonth(monthNumber - 1);

    return date.toLocaleString("id-ID", { month: monthSize });
  };
                          ...
                          <Card border="light" className="text-center p-0 mb-4">
                            <Card.Body className="pb-5">
                              <Card.Img
                                src={
                                  hover
                                    ...
                                    : getPhotoMitra(
                                        getLawyerFrontData?.code,
                                        getLawyerFrontData?.mmid_picture
                                      )
                                }
                              ...
                              <Card.Subtitle className="fw-normal">
                                {getLawyerFrontData?.email}
                              </Card.Subtitle>
                              <Card.Text className="text-gray mb-4">
                                {getLawyerFrontData?.mobile}
                              </Card.Text>
                              <div style={{ background: "white" }}>
                                <QRCode
                                  value={`${process.env.REACT_APP_BARCODES_URL}/${getLawyerFrontData?.code}`}
                                  size={70}
                                />
                              </div>
                            ...
                            <Row>
                                  ...
                                  <ul>
                                    ...
                                    <li>
                                      ...
                                      null
                                        ? "-"
                                        : `${
                                            getLawyerData?.data.date_of_birth.split(
                                              "-"
                                            )[0]
                                          } ${getMonthName(
                                            getLawyerData?.data.date_of_birth.split(
                                ...
                                <Form.Group id="dataPekerjaan">
                                  ...
                                  <ul>
                                    ...
                                    <li>
                                      ...
                                      {getLawyerData?.data
                                        .gabung_kantor_pengacara === null
                                        ? "-"
                                        : getLawyerData?.data
                                            .gabung_kantor_pengacara === "Y"
                                        ? getLawyerData?.data
                                            .mention_kantor_pengacara
                                ...
                                <Form.Group id="riwayatPendidikan">
                                  ...
                                  <ul>
                                    <li>
                                      ...
                                      {getLawyerData?.data
                                        .pendidikan_formal_hukum === null
                                        ? "-"
                                        : getLawyerData?.data
                                            .pendidikan_formal_hukum}
                                    </li>
                                    <li>
                              ...
                              <Col md={6} className="mb-3">
                                ...
                                <Form.Group id="alamatSaatIni">
                                  ...
                                  <ul>
                                    {getLawyerData?.data.currdomisilicheck ===
                                    "1" ? (
                                      <>
                                        <li>
                                          <b>Alamat : </b>
                                      ...
                                      <>
                                        ...
                                        <li>
                                          <b>Kecamatan : </b>
                                          {getLawyerData?.data
                                            .current_kecamatan_id === null
                                            ? "-"
                                            : getLawyerData?.data
                                                .current_kecamatan_id}
                                        </li>
                                        <li>
                                          <b>Kelurahan / Desa : </b>
                                          {getLawyerData?.data
                                            .current_keldesa_id === null
                                            ? "-"
                                            : getLawyerData?.data
                                                .current_keldesa_id}
                                        </li>
                                ...
                                <Form.Group id="kursusPelatihanSertifikasiYangPernahDiikuti">
                                  <Form.Label>
                                    Kursus / Pelatihan / Sertifikasi yang Pernah
                                    Diikuti
                                  </Form.Label>
                                  <ul>
                                    {[
