...
import ReactHero from "../assets/img/technologies/tnos_logo.png";
    ...
    <>
      ...
      >
        <Container className="position-relative justify-content-between px-3">
          ...
          >
            <Image src={ReactHero} />
            <span className="ms-2 brand-text d-none d-md-inline">TNOS</span>
          </Navbar.Brand>
        ...
        <Container>
          <Row>
            <Col xs={12} className="text-center">
              ...
              <h1 className="fw-bolder text-secondary">TNOS Dashboard</h1>
            ...
            <Col className="mb-md-2">
              ...
              >
                <p className="font-weight-normal font-small mb-0">
                  Copyright © PT. Xtreme Network Sistem{" "}
