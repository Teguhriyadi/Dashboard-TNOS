...
const Product = () => {
    ...
    const TableRow = ({ num, sections, column, harga, status, id }) => (
        <tr>
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${process.env.REACT_APP_API_PWA_TNOS_DSBRD_URL}/pwa-revamp/product/${section_id}`);
