...
const OthersComponents = () => {
    ...
    const TableRow = ({ num, komponen, harga, status, id }) => (
        <tr>
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${process.env.REACT_APP_API_PWA_TNOS_DSBRD_URL}/pwa-revamp/komponen-lainnya`);
            setOthersComponent(response.data.data.othersComponent);
        } catch (error) {
