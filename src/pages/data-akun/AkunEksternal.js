        ...
        return (
            <tr>
                ...
                <td className="text-center">
                    <Link to={`/data-akun/external/${member_account_code}`}>
            ...
            .then((data) => {
                ...
                if (Array.isArray(accounts)) {
                    let filteredData = accounts.filter(
                        (item) => item.account_category === "EKSTERNAL"
                    );
